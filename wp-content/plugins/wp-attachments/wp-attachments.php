        ...
        foreach ($attachments as $attachment)
            ...
            switch ( get_option('wpa_template') ) {
                case 1: //STANDARD WITH DATE
                    $wpattachments_string = '<a target="_blank" href="%URL%">%TITLE% </a> <small>(%SIZE%)</small> <div style="float:right;">%DATE%</div>';
                    break;
                case 2: //EXTENDED
                    $wpattachments_string = '<atarget="_blank" href="%URL%">%TITLE% </a> <small>&bull; %SIZE% &bull; %DOWNLOADS% click</small> <div style="float:right;">%DATE%</div><br><small>%CAPTION%</small>';
                    break;
                case 3: //CUSTOM
                    $wpattachments_string =  html_entity_decode( get_option('wpa_template_custom') );
                    break;
                default: //DEFAULT
                    $wpattachments_string = '<a target="_blank" href="%URL%">%TITLE%</a> <small>(%SIZE%)</small>';
            }
