	...
	<div class="container">
		...
		<?php
			...
			$zerif_socials_xing = get_theme_mod('zerif_socials_xing');
					$zerif_socials_impressum = get_theme_mod('zerif_socials_impressum');
			...
			!empty($zerif_copyright) || !empty($zerif_socials_instagram) ):
						...
						if(!empty($zerif_socials_facebook) || !empty($zerif_socials_twitter) || !empty($zerif_socials_linkedin) || !empty($zerif_socials_behance) || !empty($zerif_socials_dribbble)):
							...
							/* impressum */
							if( !empty($zerif_socials_impressum) ):
								echo '<li><a'.$attribut_new_tab.' href="'.esc_url($zerif_socials_impressum).'"><span class="sr-only">' . __( 'Impressum', 'zerif-lite' ) . '</span> <i class="fa fa-balance-scale"></i></a></li>';
							endif;
							echo '</ul>';
						endif;
